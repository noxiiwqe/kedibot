document.addEventListener('DOMContentLoaded', function() {
    ...
    function animateStats() {
        const stats = [
            { element: document.getElementById('serverCount'), targetValue: 5000, duration: 2000 },
            { element: document.getElementById('userCount'), targetValue: 250000, duration: 2500 },
            { element: document.getElementById('commandCount'), targetValue: 100, duration: 1500 }
        ];
